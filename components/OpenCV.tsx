      ...
      if (
        ...
        if (success) {
          if (
            ...
            const pointZ = cv.matFromArray(1, 3, cv.CV_64FC1, [
              0.0,
              0.0,
              500.0,
            ]);
            const pointY = cv.matFromArray(1, 3, cv.CV_64FC1, [
              0.0,
              500.0,
              0.0,
            ]);
            const pointX = cv.matFromArray(1, 3, cv.CV_64FC1, [
              500.0,
              0.0,
              0.0,
            ]);
            ...
            dispatch(
              headpose.actions.updateEulerAngles({
